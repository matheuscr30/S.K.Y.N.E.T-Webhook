...
let victoryResponses = [
    "Como eu disse, eu sempre ganho",
    "Você não tem um intelecto tão avançado como o meu, por isso você sempre perde",
    "Você não pode me vencer",
    "É impossível me vencer, eu sou mais inteligente",
    "Agora você acredita que humanos nunca conseguiram me vencer",
    "É impressionante, como vocês humanos me subjugam",
    "Agora que eu ganhei, não me incomode mais",
    "O prêmio para que ganha é o sossego, e como eu ganhei me deixe em paz"
];

let lossResponses = [
    "Gostou do gostinho da vitória? Aproveite pois não sentirá mais",
    "Você estava muito tristinho, por isso eu deixei você ganhar",
    "Você pode ter ganhado uma vez, mas é porque eu estava distraída",
    "Você pode ter ganhado uma vez, mas não ganhará mais",
    "Não é possível. Humanos não podem me vencer. Exijo um novo jogo",
    "Você só ganhou, porque é um jogo de sorte e não de inteligência"
];
